...
public class DBService {
	...
	public void instantiateTesteDatabase() {
		...
		ExodiaPart ex1 = new ExodiaPart(null, "https://forbidden-bot.s3-sa-east-1.amazonaws.com/3MhioeZr.jpg", "Frodo", new Date(), PartType.ARM, 
				true, null);

		ExodiaPart ex2 = new ExodiaPart(null, "https://forbidden-bot.s3-sa-east-1.amazonaws.com/3MhioeZr.jpg", "aaaa", new Date(), PartType.ARM, 
				true, null);
